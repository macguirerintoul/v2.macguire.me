...
const Winebox = () => (
  <Layout>
    <Project>
      <h1>Winebox</h1>
      <p>Winebox is a multi-platform application that elegantly assists in keeping track of a personal wine collection.</p>
      <Figure imgSrc={wineboxHero} alt='The Collection screen of Winebox' caption='The Collection screen of Winebox' />
      <ProjectInformation client='Personal Project' roles={['Interface Design', 'Branding']} tools={['Sketch', 'Flinto']} />
      <h2>Problem</h2>
      ...
      <h2>Solution</h2>
      <p>Winebox is a multi-platform app that allows people to more easily understand and manage their wine collection, no matter their level of enthusiasm. Winebox accommodates Sunday sippers and seasoned sommeliers, and tells you everything you would like to know about your wines before you have to ask.</p>
      <Showcase type='image' src={wineboxHero} alt='The Collection screen of Winebox' mediaPosition='left'>
      ...
      <p>After a couple glasses, we continued work and found that people engage with wine in a variety of contexts; at home, at dinner with friends, at liquor stores. We also noted that people could make use of their collection information in any of these contexts.</p>
      <blockquote>How might we provide a companion for the various situations that surround wine?</blockquote>
      <h2>Reflections</h2>
      <p>Winebox is under active design and development, and we hope to release a public alpha soon. We are constantly learning from quick user tests and new insights, and integrating our conclusions into the product.</p>
    </Project>
  </Layout>
)
